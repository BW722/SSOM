global function ServerChatCommand_CreateBoss_Init
...
global function KillAllBoss

array<entity> bosss = []

void function ServerChatCommand_CreateBoss_Init()
{
    if(IsLobby() || IsMenuLevel())
        return
    RegisterSignal( "AshEnteredPhaseShift" )
    RegisterSignal( "DoCore" )
    AddServerChatCommandCallback("/create_boss",  ServerChatCommand_CreateBoss)
    AddServerChatCommandCallback("/kill_all_boss",  ServerChatCommand_KillAllBoss)
}
